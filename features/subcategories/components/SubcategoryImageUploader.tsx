// features/subcategories/components/SubcategoryImageUploader.tsx
"use client";
  ...
  return (
    <div className="space-y-2">
      <div
        ...
        role="button"
        tabIndex={0}
        aria-label="Upload subcategory image"
      ...
      >
        {previewSrc ? (
          <img src={previewSrc} alt="Subcategory" className="h-full w-full object-cover" />
        ) : (
